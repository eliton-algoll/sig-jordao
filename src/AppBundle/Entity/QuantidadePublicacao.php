 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\QuantidadePublicacaoRepository")
 */
class QuantidadePublicacao extends AbstractEntity
{
     ...
     * @var Publicacao
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Publicacao", inversedBy="quantidades")
     ...
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\TipoQuantitativoPublicacao")
