 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PublicacaoRepository")
 */
class Publicacao extends AbstractEntity
{
     ...
     * @var Programa
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Programa", inversedBy="publicacoes")
     ...
     * 
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\QuantidadePublicacao", mappedBy="publicacao", cascade={"persist"})
     ...
     * 
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Projeto", mappedBy="publicacao")
     ...
     * 
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\ValorBolsaPrograma", mappedBy="publicacao")
     */
     ...
     * 
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\FolhaPagamento", mappedBy="publicacao")
    ...
    public function getQuantidadeMinimaGrupo()
    {
        return $this->quantidades->filter(function($quantidade){
            return $quantidade->getTipoQuantitativoPublicacao()->getCoSeqTipoquantidPublicacao() == \AppBundle\Entity\TipoQuantitativoPublicacao::QTD_MINIMA_BOLSISTAS_GRUPO;
        })->first();
    }
    ...
    {
        return $this->quantidades->filter(function($quantidade){
            return $quantidade->getTipoQuantitativoPublicacao()->getCoSeqTipoquantidPublicacao() == \AppBundle\Entity\TipoQuantitativoPublicacao::QTD_MAXIMA_BOLSISTAS_GRUPO;
        })->first();
    }
    ...
    /**
     * 
     * @return ArrayCollection<\AppBundle\Entity\FolhaPagamento>
     */
