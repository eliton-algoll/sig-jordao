 ...
 * @ORM\Entity(repositoryClass="\AppBundle\Repository\RetornoPagamentoRepository")
 */
class RetornoPagamento
{
     ...
     * 
     * @ORM\OneToOne(targetEntity="\AppBundle\Entity\CabecalhoArquivoRetornoPagamento", mappedBy="retornoPagamento")
     */
     ...
     * 
     * @ORM\OneToMany(targetEntity="\AppBundle\Entity\DetalheArquivoRetornoPagamento", mappedBy="retornoPagamento")
     */
     ...
     * 
     * @ORM\OneToOne(targetEntity="\AppBundle\Entity\RodapeArquivoRetornoPagamento", mappedBy="retornoPagamento")
     */
