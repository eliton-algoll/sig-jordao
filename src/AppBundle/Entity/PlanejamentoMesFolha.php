 ...
 * @ORM\Entity(repositoryClass="\AppBundle\Repository\PlanejamentoMesFolhaRepository")
 */
class PlanejamentoMesFolha extends AbstractEntity
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="\AppBundle\Entity\PlanejamentoAnoFolha")
     ...
     * @var FolhaPagamento
     * 
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\FolhaPagamento", mappedBy="planejamentoMesFolha")
     */
