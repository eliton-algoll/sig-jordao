 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\AutorizacaoFolhaRepository")
 */
class AutorizacaoFolha extends AbstractEntity
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\ProjetoFolhaPagamento", inversedBy="autorizacaoFolha")
