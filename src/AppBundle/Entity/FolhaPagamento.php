 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\FolhaPagamentoRepository")
 */
class FolhaPagamento extends AbstractEntity
{
     ...
     * @var Publicacao
     *
     * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Publicacao", inversedBy="folhasPagamento")
     ...
     * 
     * @ORM\OneToOne(targetEntity="AppBundle\Entity\PlanejamentoMesFolha")
     ...
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\ProjetoFolhaPagamento", mappedBy="folhaPagamento", cascade={"persist"})
     ...
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\TramitacaoSituacaoFolha", mappedBy="folhaPagamento", cascade={"persist"})
     ...
     * 
     * @ORM\OneToMany(targetEntity="\AppBundle\Entity\RetornoPagamento", mappedBy="folhaPagamento")
     * @ORM\OrderBy({"dtInclusao" = "DESC"})
     */
