...
/**
 * @ORM\Entity
 * @ORM\Table(name="DBPET.TB_EMISSAO_CERTIFICADO")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\EmissaoCertificadoRepository")
 */
class EmissaoCertificado extends AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPET.SQ_EMISCERTIF_COSEQEMISCERTIF", allocationSize=1, initialValue=1)
     */
    ...
    /**
     * 
     * @param \AppBundle\Entity\ProjetoPessoa $projetoPessoaParticipante
     * @param \AppBundle\Entity\ProjetoPessoa $projetoPessoaResponsavel
