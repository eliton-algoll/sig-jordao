 ...
 * @ORM\Entity(repositoryClass="\AppBundle\Repository\DetalheArquivoRetornoPagamentoRepository")
 */
class DetalheArquivoRetornoPagamento
{
     ...
     * 
     * @ORM\ManyToOne(targetEntity="\AppBundle\Entity\RetornoPagamento")
     ...
     * 
     * @ORM\OneToOne(targetEntity="\AppBundle\Entity\AutorizacaoFolha", mappedBy="detalheArquivoRetornoPagamento")
     */
