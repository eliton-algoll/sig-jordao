...
use AppBundle\Cpb\Exception\EstruturaArquivoInvalidaException;
use AppBundle\Cpb\Exception\ArquivoNotLoadedException;
use AppBundle\Cpb\Exception\ArquivoLoadedException;
