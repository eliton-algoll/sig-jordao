...
/**
 * Vota se a folha de pagamento do projeto está homologada
 */
class FolhaPagamentoHomologadaVoter extends Voter
{
    /**
    ...
    {
        return $attribute == 'HAS_FOLHA_PAGAMENTO_HOMOLOGADA';
    }
    ...
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token)
    {
        ...
        $folha = $this->folhaPagamentoQuery->findFolhaHomologadaByPublicacao($projeto->getPublicacao());
