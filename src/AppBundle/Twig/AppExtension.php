...
class AppExtension extends \Twig_Extension implements Twig_Extension_GlobalsInterface
{
     ...
     * @param Router $router
     */
    public function __construct(Router $router, TokenStorage $token, EntityManager $em)
    {
        $this->router = $router;
    ...
    {
        return array(
            new \Twig_SimpleFilter('tpTelefone', array($this, 'tipoTelefoneFilter')),
            new \Twig_SimpleFilter('strst', array($this, 'strst'), array('is_safe' => array('html'))),
            new \Twig_SimpleFilter('strstparecer', array($this, 'strstparecer'), array('is_safe' => array('html'))),
            new \Twig_SimpleFilter('undefined', array($this, 'undefined'), array('is_safe' => array('html'))),
            new \Twig_SimpleFilter('cpf', array($this, 'cpf')),
            new \Twig_SimpleFilter('strmes', array($this, 'strmes')),
            new \Twig_SimpleFilter('strtipofolha', array($this, 'strtipofolha')),
            new \Twig_SimpleFilter('int', array($this, 'toInt')),
            new \Twig_SimpleFilter('float', array($this, 'toFloat')),
            new \Twig_SimpleFilter('publicacao', array($this, 'tpPublicacao')),
            new \Twig_SimpleFilter('sitcmd', array($this, 'descricaoSitCmd')),
            new \Twig_SimpleFilter('resume', array($this, 'resume')),
            new \Twig_SimpleFilter('replaceTokenModeloCertificado', array($this, 'replaceTokenModeloCertificado'))
        );
    }
    ...
    {
        return array(
            new \Twig_SimpleFunction('showFolhaPagamentoButtons', array($this, 'showFolhaPagamentoButtons')),
            new \Twig_SimpleFunction('ascDesc', array($this, 'ascDesc')),
        );
    }
    ...
    {
        return \AppBundle\Entity\Telefone::getDsTelefone($tpTelefone);
    }
