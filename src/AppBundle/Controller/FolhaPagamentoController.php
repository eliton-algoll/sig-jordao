...
use AppBundle\Form\PesquisarFolhaPagamentoType;
use AppBundle\Form\AbrirFolhaPagamentoType;
...
class FolhaPagamentoController extends ControllerAbstract
{
    ...
    public function allAction(Request $request)
    {
        ...
        $publicacao = $params->get('publicacao') ? $manager->getReference('AppBundle:Publicacao', $params->get('publicacao')) : null;
        $situacao = $params->get('situacao') ? $manager->getReference('AppBundle:SituacaoFolha', $params->get('situacao')) : null;
    ...
    public function homologarAction(Request $request, FolhaPagamento $folha)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            try {
                ...
                $this->getBus()->handle($command);
                return $this->forward('AppBundle:FolhaPagamento:gerarHistoricoParticipantes');
    ...
    public function gerarHistoricoParticipantesAction(Request $request)
    {
        ...
        $command = new \AppBundle\CommandBus\GerarHistoricoFolhaCommand($projetoFolhaPagamento);
    ...
    public function visualizarProjetoFolhaAction(ProjetoFolhaPagamento $projetoFolha)
    {
        ...
        $autorizacaoFolhas = $em->getRepository('AppBundle:AutorizacaoFolha')->getByProjetoFolha($projetoFolha);
        $qtParticipantes = $em->getRepository('AppBundle:AutorizacaoFolha')->findQtParticipantesPorGrupoAtuacao($projetoFolha);
    ...
    public function loadFolhasByPublicacao(Publicacao $publicacao, Request $request)
    {
        $em = $this->getDoctrine()->getManager();
        $result = $em
            ->getRepository('AppBundle:FolhaPagamento')
