...
use App\CommandBus\FiltroRelatorioPagamentoCommand;
use App\CommandBus\FiltroRelatorioProjetoCommand;
use App\Entity\AutorizacaoFolha;
use App\Entity\SituacaoFolha;
use App\Form\FiltroRelatorioDetalhadoFolhaPagamentoType;
use App\Form\FiltroRelatorioFolhaPagamento;
use App\Form\FiltroRelatorioFolhaPagamentoType;
use App\Form\FiltroRelatorioGerencialPagamentoType;
use App\Form\FiltroRelatorioGerencialParticipanteType;
use App\Form\FiltroRelatorioPagamentoNaoAutorizadoType;
use App\Form\FiltroRelatorioPagamentoType;
use App\Form\FiltroRelatorioParticipanteType;
use App\Form\FiltroRelatorioProjetoType;
...
//            }
    ...
    public function pagamentoNaoAutorizado(Request $request)
    {
        ...
        $command = new \App\CommandBus\FiltroRelatorioPagamentoNaoAutorizadoCommand;
    ...
    public function gerencialPagamento(Request $request)
    {
        ...
        if ($request->isMethod('POST') && $form->isValid()) {
            $report = $this->getDoctrine()->getManager()->getRepository('App:VwGerencialPagamento')->searchRelatorio($filter);
