 ...
 * SecretariaSaude
 *
 * @ORM\Table(name="DBPETINFOSD.TB_SECRETARIA_SAUDE")
...
class SecretariaSaude extends AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPETINFOSD.SQ_SECRETSAUDE_COSEQSECRETSAUD", allocationSize=1, initialValue=1)
     */
