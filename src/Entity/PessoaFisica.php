...
class PessoaFisica extends AbstractEntity
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\PessoaPerfil", mappedBy="pessoaFisica", cascade={"persist"})
     */
     ...
     * @var Pessoa
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Pessoa")
     ...
     * @var DadoPessoal
     *
     * @ORM\OneToOne(targetEntity="App\Entity\DadoPessoal", mappedBy="pessoaFisica", cascade={"persist"})
     */
    private $dadoPessoal;
     ...
     * @var Usuario
     *
     * @ORM\OneToOne(targetEntity="App\Entity\Usuario", mappedBy="pessoaFisica")
     */
    private $usuario;
