...
class ProjetoFolhaPagamento extends AbstractEntity
{
     ...
     * @var FolhaPagamento
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\FolhaPagamento", inversedBy="projetosFolhaPagamento")
     ...
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\SituacaoProjetoFolha")
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\AutorizacaoFolha", mappedBy="projetoFolhaPagamento", cascade={"persist", "persist"})
