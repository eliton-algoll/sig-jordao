 ...
 * SituacaoFolha
 *
 * @ORM\Table(name="DBPETINFOSD.TB_SITUACAO_FOLHA")
 * @ORM\Entity(repositoryClass="App\Repository\SituacaoFolhaRepository")
 */
class SituacaoFolha extends AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPETINFOSD.SQ_SITUAFOL_COSEQSITUACAOFOLHA", allocationSize=1, initialValue=1)
     */
