...
class Projeto extends AbstractEntity
{
     ...
     * @var Publicacao
     *
     * @ORM\ManyToOne(targetEntity="App\Entity\Publicacao", inversedBy="projetos")
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\ProjetoPessoa", mappedBy="projeto")
     */
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\ProjetoCampusInstituicao", mappedBy="projeto", cascade={"persist"})
     */
    private $campus;
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\AreaTematica", mappedBy="projeto", cascade={"persist"})
     */
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\SecretariaSaude", mappedBy="projeto", cascade={"persist"})
     */
    private $secretarias;
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\ProjetoEstabelecimento", mappedBy="projeto", cascade={"persist"})
     */
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\GrupoAtuacao", mappedBy="projeto", cascade={"persist"})
     */
    ...
    /**
     * 
     * @return null|\App\Entity\ProjetoPessoa
     */
    ...
    /**
     * 
     * @return ArrayCollection<\App\Entity\ProjetoPessoa>
     */
