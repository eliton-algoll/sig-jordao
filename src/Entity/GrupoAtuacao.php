 ...
 * GrupoAtuacao
 *
 * @ORM\Table(name="DBPETINFOSD.TB_GRUPO_ATUACAO")
 * @ORM\Entity(repositoryClass="App\Repository\GrupoAtuacaoRepository")
 */
class GrupoAtuacao extends AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPETINFOSD.SQ_GRUPOATUACAO_COSEQGRPATUAC", allocationSize=1, initialValue=1)
     */
    private $coSeqGrupoAtuacao;

    /**
     * @var ArrayCollection<AreaTematicaGrupoAtuacao>
     * @ORM\OneToMany(targetEntity="App\Entity\AreaTematicaGrupoAtuacao", mappedBy="grupoAtuacao", cascade={"persist"})
     */
    private $areasTematicasGruposAtuacao;

    /**
     * @var ArrayCollection<ProjetoPessoaGrupoAtuacao>
     * @ORM\OneToMany(targetEntity="App\Entity\ProjetoPessoaGrupoAtuacao", mappedBy="grupoAtuacao")
     */
