...
class Pessoa extends AbstractEntity
{
     ...
     * @ORM\OneToMany(targetEntity="App\Entity\Telefone", mappedBy="pessoa", cascade={"persist"})
     ...
     * @var Endereco
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\Endereco", mappedBy="pessoa", cascade={"persist"})
     */
    private $enderecos;
     ...
     * 
     * @ORM\OneToMany(targetEntity="App\Entity\EnderecoWeb", mappedBy="pessoa", cascade={"persist"})
