 ...
 * Instituicao
 *
 * @ORM\Table(name="DBPETINFOSD.TB_INSTITUICAO")
...
class Instituicao extends AbstractEntity
{
     ...
     * @ORM\SequenceGenerator(sequenceName="DBPETINFOSD.SQ_INSTITUICAO_COSEQINSTITUICA", allocationSize=1, initialValue=1)
     */
